document.addEventListener("DOMContentLoaded", function() {
    ...
    document.body.addEventListener("click", function() {
        ...
        if (currentScreen === 7) {
            ...
            if (!finalpicture) {
                document.querySelector('#final1').classList.add('fade-out');
...
// console.log(questionIndex)
    ...
    function updateFinalScreen(outcome) {
        ...
        const flavordetails1 = {
            d12: `An admirer of timeless classics.<br>
You have a thirst for discovering<br>
genuine works of excellence.`,
            d15: `Traditional in values, yet embracing<br>
modernity. You seek experiences<br>
where these worlds meet, to create<br>
something truly unique.`,
            d18: `An individual who embraces life<br>
with bold enthusiasm. You value<br>
experiences that are rare and<br>
most importantly Unforgettable.`,
            dd21: `An innovator at heart, you value<br>
the craftsmanship needed to create<br>
something truly sophisticated.`,
            d12_highball: `With a passion for authentic<br>
experiences shared with friends,<br>
you value the timeless classics<br>
that suit any occasion.`,
            dd21_old_fashioned: `As a trendsetter, you admire<br>
the reinvention of a classic. The<br>
perfect cocktail of complexity<br>
and sophistication.`
        }
            
        const flavordetails2 = {
            d12: `Most inspired when out in nature,<br>
you are drawn to the luxurious notes<br>
of lush fruit, citrus and vanilla.`,
d15: `Luscious honey and delicate floral notes<br>
indulge your tastes for rare opulence.`,
            d18: `Refined luxury to you is rich, velvety notes<br>
of dark chocolate, dried fruits, dark honey,<br>
and marzipan.`,
            dd21: `You Savour the luxury of ultimate<br>
smoothness, with notes of cinnamon,<br>
cacao and ripe vine fruits.`,
            d12_highball: `With a passion for authentic<br>experiences shared with friends,<br> you value the timeless classics.<br>
A well-rounded, refreshing drink with<br> notes of lush fruit, citrus and vanilla,<br> perfectly suits any occasion.`,
            dd21_old_fashioned: `Silky smooth notes of cinnamon,<br>
cacao and ripe vine fruits, perfectly<br>
match your refined tastes.`
        }
        const imagelookup = {
        ...
        document.getElementById('flavordetails1').innerHTML = flavordetails1[outcome];
        document.getElementById('flavordetails2').innerHTML = flavordetails2[outcome];
    }
...
document.getElementById("restartbutton").addEventListener('click', function () {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    video.play();        // Programmatically start playing the video

    // For devices that may not respect autoplay, try using a promise
    video.oncanplay = function() {
      video.play().catch(() => {
        // Autoplay may be blocked; add the muted attribute and try again
        video.muted = true;
        video.play();
      });
    };
